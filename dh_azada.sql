...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2026 at 11:56 AM
...
CREATE TABLE `appointments_tbl` (
  ...
  `appt_status` enum('waiting for approval','approved','rejected','cancelled','completed') DEFAULT 'waiting for approval',
  `created_at` datetime DEFAULT NULL,
  `tires_product_id` int(11) DEFAULT NULL,
  `tires_qty` int(11) DEFAULT NULL,
  `batteries_product_id` int(11) DEFAULT NULL,
  `magwheels_product_id` int(11) DEFAULT NULL,
  `magwheels_qty` int(11) DEFAULT NULL,
...
INSERT INTO `appointments_tbl` (`appt_id`, `customer_id`, `service_id`, `employee_id`, `appt_date`, `appt_time`, `purpose`, `notes`, `appt_status`, `created_at`, `tires_product_id`, `tires_qty`, `batteries_product_id`, `magwheels_product_id`, `magwheels_qty`, `total_cost`) VALUES
(1, 2, NULL, NULL, '2026-04-04', '08:00:00', 'TIRE AND WHEEL CHANGE, BATTERY CHANGE, MAGWHEEL CHANGE, UNDERCHASSIS, VULCANIZE', 'dwxad', 'waiting for approval', '2026-04-03 16:06:47', 8, 1, 5, 1, 1, 18000.00);
...
(2, 'ricardoabatantonio@gmail.com', '$2y$10$nw84KjUN4/Ho32Q5gpuWKOi3Vi0nsm5SzrBBzGW2XyRuMZeY9ugzG', 'ako', 'si', 'juan', '2003-09-26', NULL, '09777309031', NULL, '2026-04-03 11:12:25', 'active', '../uploads/profile/customer_2_1775203951.png');
...
(4, 1, 2, 0, 18000.00, 'cash', '2026-04-03 17:35:38');
